...
import { Shell, Sprout } from "lucide-react";
...
async function ProductGrid({ searchParams }: { searchParams: { [key: string]: string | undefined } }) {
  ...
  if (!products || products.length === 0) {
    return (
      <div className="text-center py-20 bg-white/50 rounded-2xl border border-gray-200 mx-auto max-w-2xl">
  ...
  return (
    <div className="min-h-screen pt-24 pb-20 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-8">
          <h1 className="text-3xl md:text-5xl font-bold font-serif text-gray-900 mb-4">Our Collection</h1>
          <p className="text-gray-600 text-lg">Browse our premium 100% pure and organic honey varieties.</p>
        </div>
