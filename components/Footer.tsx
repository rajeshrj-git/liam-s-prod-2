      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="mb-4">
              <img src="/fssai.png" alt="FSSAI Code" className="h-10 w-auto object-contain opacity-90" />
            </div>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              Premium natural honey. Quality tested, fully certified, and backed by our comprehensive purity guarantee.
            </p>
            <div className="flex gap-4">
              <a href="https://www.instagram.com/_bee_kiss?igsh=a3B1dmd0bXFjdjMw" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-accent transition-colors"><Instagram size={20} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/terms" className="text-gray-600 hover:text-accent transition-colors text-sm">Terms & Conditions</Link></li>
            </ul>
          </div>
